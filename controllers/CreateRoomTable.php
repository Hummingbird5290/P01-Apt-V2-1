  <?php
                ...
                $sql = "SELECT Room.Id Id,Room_No, room.RoomType_Id, Start_date, End_Date, Status_Room, RoomType, RoomDetail, Room_Rates, rt.flag ,
                ...
                while( $row=mysqli_fetch_array($query) ) {  // preparing an array
                                ...
                                //         {
                                                 $Flag = "Edit";
                                //                 $nestedData[] = "<a href = 'CreateBook.php?id=$roomID&idb=$Book_Id&flag=$Flag'>แก้ไขการจอง</a>"; 
                                //         }
                                
                                // }else {$nestedData[] = "";}//&type=$RoomType_Id
                                $nestedData[] = "<a href = 'CreateRoom.php?id=$roomID&flag=$Flag'>แก้ไข</a>";			
                                $data[] = $nestedData;
                        }
                $json_data = array(
