  <?php
                ...
                while( $row=mysqli_fetch_array($query) ) {  // preparing an array
                                ...
                                {
                                        $Flag = "Save";                                       
                                        $nestedData[] = "<a href = 'CreateRoomStatusOut.php?id=$roomID&ConId=$ConId&flag=$Flag '>เลือก</a>"; 
                                }
                                if($row["Status_Room"]==4 )
                                {
                                        $Flag = "Save";                                      
                                                $Flag = "Edit";
                                                $nestedData[] = "<a href = 'CreateRoomStatusOut.php?id=$roomID&ConId=$ConId&flag=$Flag'>แก้ไข</a>"; 
                                }		
                                $data[] = $nestedData;
                        }
                $json_data = array(
