  ...
  <!--body-->       
        ...
        <div class="content-wrapper">
          ...
          <section class="content-header">
            <h1>
              หน้าหลัก 
              <small>สร้างห้อง</small>
            </h1>
            <ol class="breadcrumb">
              <li><a href="BackEnd.php"><i class="fa fa-dashboard"></i> หน้าหลัก</a></li>
              <li class="active">สร้างห้อง</li>
            </ol>
          </section>
          <!-- Main content -->
          <section class="content">
          <?php require('view/CreateRoom.php'); ?> 
          </section><!-- /.content -->
        </div><!-- /.content-wrapper -->
<?php
$page->endBody();
...
<script type="text/javascript" language="javascript">
      $(document).ready(function () {
        var dataTable = $('#myTableRoom').DataTable({
            "processing": true,
            "serverSide": true,
            "paging": true,
            "lengthChange": true,
            ...
            "autoWidth": true,
          "ajax": {
            url: "controllers/CreateRoomTable.php", // json datasource           
