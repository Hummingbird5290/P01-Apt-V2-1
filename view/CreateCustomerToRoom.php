...
<?php
    ...
    require_once("controllers/RoomCls.php");    
            ...
            if (isset($_REQUEST['Edit'])) { 
              ...
              $CustomerToRoom = new CustomerToRoom();     
              $user =$_SESSION['Username'];  
              //echo "$RoomId - $Amount_book - $Title - $Name - $Lastname - $CardId - $Email- $Tel-$Tel2-$Address- $DateCon";   
              $result = $CustomerToRoom->CreateCustomarToRoom($Id,$Title, $Name, $Lastname, $CardId, $Email, $Tel, $Tel2, $Address,$user,$Amount_book,$DateCon,null);
              //echo $result; 
              ...
              //$result = $CustomerToRoom->GetCustomerToRoom($Id);
              //$result = $CustomerToRoom->UdateStatusBooking($Idb);          
              //$result = $CustomerToRoom->CreateContract($Id,$user,$Bookdate,$Book_Amount);
              //$result = $CustomerToRoom->UdateStatusRoom($Id);
              //echo $result;    
            }            
...
if($flag=="Edit")  {
 ...
 <div class=\"box box-primary\">
      <div class=\"box-header with-border\">
        <h3 class=\"box-title\">บันทึกการเข้าพักครั้งแรก</h3>
      </div>   
  <div class=\"box-body\">              
       <div class=\"col-md-6\">
         <div class=\"form-group\">                                  
            <label for=\"ห้อง\">ห้อง</label> 
              ...
              <div class=\"col-md-6\">        
                <div class=\"form-group\">
                  ...
                  <input type=\"input\" class=\"form-control\" name=\"Amount_book\" 
                  value=\"";   
                if (isset($flag))
                  {
                    if ($flag=="Edit")
             ...
             <div class=\"col-md-12\">        
                <div class=\"form-group\">
                  ...
                  <div class=\"input-group\">
                      ...
                      <input class=\"form-control\" Name=\"DateCon\" id =\"datebook\" 
                        value=\"";   
                          if (isset($flag))
                          {
                            if ($flag=="Edit")
            ...
            <div class=\"col-md-6\">
              <div class=\"form-group\">
                ...
                <input type=\"input\" class=\"form-control\" name=\"CardId\" value=\"";    
                  ...
                  echo "\" placeholder=\"รหัสบัตรประชาชน\" data-inputmask='\"mask\": \"9-9999-99-999-99-9\"' data-mask required Disabled>
                </div>
              </div>
            </div>
            <div class=\"col-md-6\">
            ...
            <div class=\"col-md-12\">
              <div class=\"form-group\">
                ...
                <textarea class=\"form-control\" name=\"Address\" placeholder=\"ที่อยู่ตามทะเบียนบ้าน\" Disabled>";    
                  if (isset($flag))
                  {
                    if ($flag=="Edit")
                        { 
...
{
  //Create New CustomerToRoom to Room
  echo "<div class=\"col-md-5\">         
 <div class=\"box box-primary\">
      <div class=\"box-header with-border\">
        <h3 class=\"box-title\">บันทึกการเข้าพักครั้งแรก</h3>
