...
$page = new Page;
$page->setTitle('CreateBill - Receive');
$page->startBody();
?>
<!--body-->       
        ...
        <div class="content-wrapper">
          ...
          <section class="content-header">
            <h1>
              หน้าหลัก 
              <small>พิมพ์ใบเสร็จ</small>
            </h1>
            <ol class="breadcrumb">
              <li><a href="#"><i class="fa fa-dashboard"></i> หน้าหลัก</a></li>
              <li class="active">พิมพ์ใบเสร็จ</li>
            </ol>
          </section>
          <!-- Main content -->
          <section class="content">
          <?php 
          require('view/Formprintpayment.php');
          ?>          
          </section><!-- /.content -->
        </div><!-- /.content-wrapper -->
<!--Footer-->
...
<script type="text/javascript" language="javascript">
      $(document).ready(function () {
        var dataTable = $('#myTable2').DataTable({
          ...
          "serverSide": true,
          "ajax": {
            url: "controllers/GetgridpaymentCls.php", // json datasource
