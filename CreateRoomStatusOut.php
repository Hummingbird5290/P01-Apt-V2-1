...
<!--body-->       
        ...
        <div class="content-wrapper">
          ...
          <section class="content-header">
            <h1>
              หน้าหลัก 
              <small>แจ้งออกจากห้องพัก</small>
            </h1>
            <ol class="breadcrumb">
              <li><a href="#"><i class="fa fa-dashboard"></i> หน้าหลัก</a></li>
              <li class="active">แจ้งออกจากห้องพัก</li>
            </ol>
          </section>
          <!-- Main content -->
          <section class="content">
          <?php 
           require('view/CreateRoomStatusOut.php');        
          ?>          
          </section><!-- /.content -->
        </div><!-- /.content-wrapper -->
<?php
 ...
 <script type="text/javascript" language="javascript">
      $(document).ready(function () {
        var dataTable = $('#myTableRoomStatusOut').DataTable({
            ...
            "autoWidth": true,
          "ajax": {
            url: "controllers/CreateRoomStatusOutTable.php", // json datasource           
